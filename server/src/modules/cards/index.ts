...
import { GetCardDebtsUseCase } from '@/modules/cards/application/use-cases/get-card-debts/get-card-debts.use-case'
...
import { GetCardDebtsController } from '@/modules/cards/http/controllers/get-card-debts.controller'
