...
import { useTotalPurchasesAmount } from '@/features/dashboard/hooks/use-total-purchases-amount'
import { formatPrice } from '@/lib/utils'

export function TotalPurchasesAmountCard() {
  const { data } = useTotalPurchasesAmount()
